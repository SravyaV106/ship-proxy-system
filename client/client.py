...
OFFSHORE_HOST = os.environ.get("OFFSHORE_HOST", "127.0.0.1")  # change if offshore runs elsewhere
...
def process_request(client_sock, client_addr):
    try:
        ...
        print(f"[SHIP] Error handling {client_addr}: {e}")
    finally:
        client_sock.close()
